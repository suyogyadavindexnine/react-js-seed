...
const SnapCore = () => {
  return (
    <>
      <PageTitleWrapper>
        <PageTitle
          heading="Snap.Core Features"
          subHeading="Explore the core features of the SnapCore platform."
          showDocumentationText={false} 
          showButton={false}
        />
      </PageTitleWrapper>

      <Grid container spacing={3} padding={4} paddingTop={0} justifyContent="center">
