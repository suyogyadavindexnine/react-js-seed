import { DEMO_EMAILS, I18N } from 'src/shared/constants/constants';
...
const LoginByUserNamePasswordForm = ({
  loginType,
  getOtpOnEmail,
  setIsOnEmailScreen
}: LoginProps) => {
        ...
        {loginRoles.map((role, index) => (
          <Chip
            ...
            sx={{
              ...
              '&:hover': {
                backgroundColor:
                  clickedRole === index ? 'primary.dark' : 'rgba(0, 0, 0, 0.08)'
              }
            }}
          ></Chip>
        ))}
...
export default LoginByUserNamePasswordForm;
